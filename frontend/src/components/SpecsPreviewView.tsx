      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 print:hidden">
        <div>
          ...
          <p className="text-xs text-[#585956]">
            Review the finalized document before exporting or sending to the client.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2 flex-wrap justify-end">
          ...
          >
            ...
            <span>{copiedLink ? "Copied Link!" : "Share Invoice"}</span>
          </button>
          ...
          >
            ...
            <span>{downloaded ? "Printing..." : "Export as PDF"}</span>
          </button>
          ...
          <div className="border-t border-[#dadad7] pt-5 grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-[#585956] mt-0.5 text-[11px]">
                Max Budget Scope: <span className="font-mono font-bold text-[#141514]">RM {targetBudget.toLocaleString()}</span>
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-6 pt-2">
            <div className="flex-1 p-4 rounded-lg bg-[#fbfbfa] border border-[#dadad7] self-start max-w-md">
              ...
              <p className="text-[10px] text-[#878884] leading-relaxed">
                1. Quotation prices are sealed for a window of thirty (30) days from issuance.<br />
        ...
        <div className="flex justify-between items-end border-t border-[#dadad7] pt-8 mt-12 gap-6">
          <div className="space-y-1">
            <p className="text-[10px] text-[#585956]">
              Generated by Componentry CPQ Engine • Document ID: TRD-518946
            </p>
          </div>
          ...
          <div className="w-56 text-center">
            ...
            <div className="border-t border-[#878884] pt-2">
              ...
              <p className="text-[9px] text-[#878884] mt-1">TechRigs automated CPQ dispatcher</p>
            </div>
          </div>
        </div>
